    ...
    if (response.status === 201 && results) {
      ...
      const enhancedResults = results.map((result) => {
        ...
        return {
          ...
          correct_answer_image: correctOption ? correctOption.answer_image : null, // Include correct answer image
          selected_answer: selectedOption ? selectedOption.answer_text : 'N/A',
          selected_answer_image: selectedOption ? selectedOption.answer_image : null, // Include selected answer image
          is_correct: result.is_correct,
          answers: question.answers.map(option => ({
            answer_text: option.answer_text,
            answer_image: option.answer_image, // Include answer image
